...
ALIASES = {
    ...
    "название парламента (схема)": "parliament_chart_title",
    "схема парламента": "parliament_parties",
    "партии для схемы парламента": "parliament_parties",
    "партии парламента": "parliament_parties",
    "порог большинства": "parliament_majority",
    "подпись к схеме парламента": "parliament_note",
    "идеология": "ideology",
