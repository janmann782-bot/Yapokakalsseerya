...
BATTLE = Template(
    ...
    fields=(
        ...
        f("result", "Итог", "Основные сведения"),
        f("side_1", "Сторона 1", "Противники", 1),
        f("side_2", "Сторона 2", "Противники", 2),
...
PARLIAMENT = Template(
    ...
    label="Парламент",
    emoji="🏛",
    image_label="первая картинка — флаг страны; логотипы подпиши как party: Название партии",
    subtitle_key="country",
    wizard=("title", "country", "total_seats", "seat_shape", "parties", "term"),
    fields=(
        ...
        f("majority", "Порог большинства (если нужен особый)", "Основные сведения"),
        f("term", "Созыв / период", "Основные сведения"),
        f("parties", "Партии и места (Название, места, #цвет / rgb(...))", "Состав", multiline=True),
        f("seat_shape", "Вид мест (круг / квадрат)", "Состав"),
        f("note", "Примечание (необязательно)", "Примечание", multiline=True),
    ),
)
...
TEMPLATES = {x.key: x for x in (COUNTRY, REGION, BATTLE, PERSON, PARLIAMENT, NEWS, SUPEREVENT, MIROTORETS)}
